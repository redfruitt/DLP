  ...
  <div>
    <div class="page-header page-header-small">
      <parallax
        ...
        style="background-image: url('img/topbg1.jpg')"
      >
      </parallax>
      <div class="content-center">
        <div class="container">
          <h1 class="title">Digiteria</h1>
          <h3>Enhancing your brand's digital presence.</h3>
          ...
          <div class="row">
            <div class="col-md-6">
              <div
                ...
                style="background-image: url('img/dashboard.jpg')"
              >
              ...
              <div
                ...
                style="background-image: url('img/timesquare.jpg')"
              ></div>
            </div>
            <div class="col-md-5">
              ...
              <div
                ...
                style="background-image: url('img/ecomm.jpg')"
              ></div>
              <h3>
